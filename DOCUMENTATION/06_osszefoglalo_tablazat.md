...
|Dokumentáció|DOCUMENTATION/|A projekt bemutató anyagai.|Minden dokumentum az új elérési utakat használja.|
...
|3|`02\_backend\_futtatas\_es\_teszteles.md`|Backend indítása és tesztadatok.|
|4|`03\_adatbazis\_mezok\_es\_kapcsolatok.md`|Adatbázis mezők és kapcsolatok.|
