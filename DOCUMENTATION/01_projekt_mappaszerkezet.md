...
|BACKEND/app/extensions.py|Bővítmények|Közös db és auth objektumok.|
...
|BACKEND/init\_db.py|Adatbázis inicializálás|Újragenerálja a táblákat és betölti a kezdő felhasználókat/autókat.|
...
|DOCUMENTATION/|Dokumentáció|Az aktuális projektstruktúrát, adatbázist, végpontokat és kliensoldali tervet bemutató fájlok.|
|BerAuto.code-workspace|VS Code multi-root workspace|Egyszerre nyitja meg a BACKEND, FRONTEND és DOCUMENTATION mappákat.|
|.gitignore|Kihagyási szabályok|Nem kerülnek csomagolásra a .venv, **pycache**, pyc és lokális fájlok.|
